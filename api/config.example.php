...
return [
    ...
    // Gallery moderation secret. Set a long random string and keep it private —
    // it's what lets you hide a build. Leave empty to disable API moderation
    // entirely (you can always hide things directly in phpMyAdmin).
    'admin_token' => '',
